...
BEGIN
	...
	LOOP	
					...
					SELECT T1.*,
					 ...
					 FROM (
						SELECT CXP.PROVEEDOR,
						       ...
						       ((SELECT DOCUMENTO  FROM FIN.CXP_DOC D 
									WHERE D.DOCUMENTO_RELACIONADO =CXP.DOCUMENTO 
									AND D.DESCRIPCION ILIKE 'CANCELA FACTURA CONTRATISTA POR TRASLADO A FINTRA:%' 
									AND D.TIPO_DOCUMENTO='NC' AND D.PROVEEDOR=CXP.PROVEEDOR)) as DOCUMENTO_SOPORTE        	
		...
		LOOP						
			...
			MCTYPE.MC_____OBSERVACI_B := SUBSTRING(INFOITEMS_.NUM_OS ||' : '|| INFOITEMS_.DESCRIPCION || : || DOCUMENTO_SOPORTE,1,249);
