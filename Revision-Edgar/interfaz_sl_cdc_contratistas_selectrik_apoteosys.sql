...
-- delete from con.mc_sl_fac_cc_sel where MC_____CODIGO____CONTAB_B = 'SELE' AND MC_____CODIGO____CD_____B = 'CFSL'					
-- SELECT COUNT(*) from con.mc_sl_fac_cc_sel where MC_____CODIGO____CONTAB_B = 'SELE' AND MC_____CODIGO____CD_____B = 'CFSL' AND PROCESADO='N'	
		...
		/**BUSCAMOS LA INFORMACION COMPLETA QUE CONFORMARA EL ASIENTO CONTABLE PARA MANDARLO A APOTEOSYS*/
				...
				FOR INFOITEMS_ IN 			        
						...
						SELECT * FROM (
								...
								INNER JOIN FIN.CXP_DOC AA ON (AA.TIPO_DOCUMENTO=A.TIPO_DOCUMENTO AND A.DOCUMENTO=AA.DOCUMENTO AND AA.PROVEEDOR=A.PROVEEDOR)
