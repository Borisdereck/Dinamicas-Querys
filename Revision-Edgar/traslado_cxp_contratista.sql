-- Table: tem.traslado_cxp_contratista

-- DROP TABLE tem.traslado_cxp_contratista;

CREATE TABLE tem.traslado_cxp_contratista
(
  id serial NOT NULL,
...
ALTER TABLE tem.traslado_cxp_contratista
  OWNER TO postgres;
