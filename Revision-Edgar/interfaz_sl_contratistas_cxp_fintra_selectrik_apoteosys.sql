-- Function: SELECT con.interfaz_sl_contratistas_cxp_fintra_selectrik_apoteosys()
...
BEGIN
	...
	FOR FACTURA_NM IN 
			...
			AND   CXP.PERIODO		='201705'
			AND   CXP.REG_STATUS		=''
			AND   CXP.DESCRIPCION 		LIKE 'CXP A FINTRA TRASLADO ING MS%'
			--AND   COALESCE(CXP.PROCESADO, 'N') = 'N'
			AND   DOCUMENTO NOT IN (SELECT DOCUMENTO FROM FIN.CXP_DOC WHERE DOCUMENTO IN ('T00000425','T00000417','T00000419','T00000428','T00000440','T00000441','T00000447','T00000448','T00000635'))
			--AND DOCUMENTO = 'T00000507'
