				...
				WHERE 
					...
					AND A.DESCRIPCION 		= 	'CXP A SELECTRICK INGRESOS' 
				      --AND COALESCE(INDICADOR_TRASLADO_FINTRA, 'N' ) = 'N'
				       AND A.DOCUMENTO NOT IN (SELECT DOCUMENTO FROM TEM.TRASLADO_CXP_CONTRATISTAS_FINTRA_SELECTRIK WHERE HANDLE_CODE = 'SL')
...
-- 			END IF;
		...
		IF(SW = 'S')THEN
			...
			INSERT INTO TEM.TRASLADO_CXP_CONTRATISTAS_FINTRA_SELECTRIK (PERIODO , DOCUMENTO, CONCEPTO, PROCESADO, CREATION_DATE , CREATION_USER, LAST_UPDATE , USER_UPDATE) 
