	...
	FOR FACTURA_NM IN 
				...
				--AND COALESCE(INDICADOR_TRASLADO_FINTRA, 'N' ) = 'N'
				  AND A.DOCUMENTO NOT IN (SELECT DOCUMENTO 
						          ...
						          WHERE  HANDLE_CODE 		= 'SL' 
							    AND  TIPO_DOCUMENTO 	= FACTURA_NM.TIPO_DOCUMENTO 
...
-- 			END IF;
		...
		IF(SW = 'S')THEN
			...
			INSERT INTO TEM.TRASLADO_CXP_CONTRATISTAS_FINTRA_SELECTRIK (PERIODO , DOCUMENTO, CONCEPTO, PROCESADO, CREATION_DATE , CREATION_USER, LAST_UPDATE , USER_UPDATE, PROVEEDOR, TIPO_DOCUMENTO) 
